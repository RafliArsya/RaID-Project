local old__update_check_actions = PlayerCivilian._update_check_actions
...
function PlayerCivilian:__check_action_jump(t, input, ...)
...
Hooks:PostHook(PlayerCivilian, "_start_action_ducking", "RaID_PlayerCivilian__start_action_ducking", function(self, t)
	self._ext_movement:set_attention_settings({
		"pl_civilian"
	})
end)

Hooks:PostHook(PlayerCivilian, "_end_action_ducking", "RaID_PlayerCivilian__end_action_ducking", function(self, t, skip_can_stand_check)
	self._ext_movement:set_attention_settings({
		"pl_civilian"
	})
end)