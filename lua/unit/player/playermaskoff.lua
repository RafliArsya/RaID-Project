...
Hooks:PostHook(PlayerMaskOff, "_start_action_ducking", "RaID_PlayerMaskOff__start_action_ducking", function(self, t)
...
Hooks:PostHook(PlayerMaskOff, "_end_action_ducking", "RaID_PlayerMaskOff__end_action_ducking", function(self, t, skip_can_stand_check)
	self._ext_movement:set_attention_settings({
		"pl_mask_off_friend_combatant",
		"pl_mask_off_friend_non_combatant",
		"pl_mask_off_foe_combatant",
